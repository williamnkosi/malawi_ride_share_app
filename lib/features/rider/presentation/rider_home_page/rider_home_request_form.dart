...
class RiderHomeRequestForm extends StatefulWidget {
  const RiderHomeRequestForm({super.key});

  @override
  State<RiderHomeRequestForm> createState() => _RiderHomeRequestFormState();
}

class _RiderHomeRequestFormState extends State<RiderHomeRequestForm> {
        ...
        children: [
          GooglePlacesAutoCompleteTextFormField(
            ...
            onSuggestionClicked: (Prediction prediction) {
              ...
              _pickUpPrediction = prediction;
              logger.info('Pickup prediction set: ${prediction.description}');
            },
            minInputLength: 3,
          ),
          ...
          GooglePlacesAutoCompleteTextFormField(
            ...
            onSuggestionClicked: (Prediction prediction) {
              ...
              logger.info('Dropoff prediction set: ${prediction.description}');
            },
            minInputLength: 3,
          ),
          const SizedBox(height: 24),
              ...
              return TextButton(
                onPressed: () {
                  ...
                  if (_formKey.currentState!.validate()) {
                    logger.info('Form is valid, adding request trip event');
                    context.read<RiderOperationsBloc>().add(
                      RequestTripEvent(
                        ...
                        destinationLat: double.parse(_dropOffPrediction!.lat!),
                        destinationLng: double.parse(_dropOffPrediction!.lng!),
